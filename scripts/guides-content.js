...
module.exports = [
...

  {
    ...
    body: `
      ...
      <h2>Penn State did not rebuild, it relocated</h2>
      <p>Becht and Sowell are two names out of roughly two dozen. When Matt Campbell left Iowa State for Penn State, he brought a sizable share of his roster with him, and the Nittany Lions now list more than 20 players whose previous school was Iowa State. Programs have always poached individual players. Moving most of a depth chart in one offseason is new.</p>
